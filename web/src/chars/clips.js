...
C('slide', {
  ...
  keys: [
    ...
    { t: 0.14, ease: 'whip', pose: { base: { py: -0.82, rx: 36, pz: -0.3 }, hips: { rx: 6 }, chest: { rx: -14, ry: -10 }, neck: { rx: 16 }, legL: { rx: 104, rz: -8 }, kneeL: [-16, 0, 0], footL: [26, 0, 0], legR: { rx: 74, rz: 24 }, kneeR: [-112, 0, 0], armL: { rx: 34, rz: -92 }, elbL: [30, 0, 0], armR: { rx: 34, rz: 96 }, elbR: [26, 0, 0], shirt: [40, 0, 0] } },
    // THE HELD SKID — the poster frame: hips on the road, leading leg horizontal, arms wide
    { t: 0.34, ease: 'hold', pose: { base: { py: -1.04, rx: 46, pz: -0.16 }, hips: { rx: 8 }, chest: { rx: -12, ry: -14 }, neck: { rx: 20, ry: 12 }, legL: { rx: 132, rz: -10 }, kneeL: [-8, 0, 0], footL: [32, 0, 0], legR: { rx: 96, rz: 26 }, kneeR: [-124, 0, 0], armL: { rx: 42, rz: -122 }, elbL: [20, 0, 0], armR: { rx: 42, rz: 128 }, elbR: [16, 0, 0] } },
    { t: 0.70, ease: 'hold', pose: { base: { py: -1.08, rx: 48, pz: -0.1 }, hips: { rx: 8 }, chest: { rx: -14, ry: -18 }, neck: { rx: 22, ry: 16 }, legL: { rx: 138, rz: -11 }, kneeL: [-4, 0, 0], footL: [34, 0, 0], legR: { rx: 98, rz: 27 }, kneeR: [-128, 0, 0], armL: { rx: 46, rz: -130 }, elbL: [16, 0, 0], armR: { rx: 46, rz: 134 }, elbR: [14, 0, 0] } },
    // hand down on the chalk, a beat of stillness
    { t: 0.98, ease: 'hold', pose: { base: { py: -1.02, rx: 40 }, chest: { rx: -10, ry: -22 }, neck: { rx: 18, ry: 20 }, legL: { rx: 116, rz: -8 }, kneeL: [-26, 0, 0], legR: { rx: 88, rz: 24 }, kneeR: [-112, 0, 0], armL: { rx: 56, rz: -142 }, elbL: [12, 0, 0], armR: { rx: 12, rz: 42 }, elbR: [60, 0, 0] } },
    // pick yourself up
...
C('mob_pile', {
  ...
  keys: [
    ...
    { t: 0.16, ease: 'whip', pose: { base: { py: 0.50, pz: -0.26, sy: 0.14, sx: -0.07, sz: -0.07 }, hips: { rx: -7 }, chest: { rx: -6, rz: -6 }, neck: { rx: 26, ry: 10 }, armL: { rx: -26, rz: -136 }, armR: { rx: -26, rz: 136 }, elbL: [14, 0, 0], elbR: [14, 0, 0], legL: { rx: -14, rz: -10 }, legR: { rx: -22, rz: 10 }, kneeL: [-62, 0, 0], kneeR: [-78, 0, 0], footL: [-26, 0, 0], footR: [-26, 0, 0], shirt: [36, 0, 0], brim: [18, 0, 0] } },
    { t: 0.32, ease: 'hold', pose: { base: { py: 0.66, pz: -0.32, sy: 0.09, sx: -0.045, sz: -0.045 }, hips: { rx: -9 }, chest: { rx: -2, rz: 8 }, neck: { rx: 28, ry: -12 }, armL: { rx: -22, rz: -150 }, armR: { rx: -30, rz: 142 }, elbL: [6, 0, 0], elbR: [12, 0, 0], legL: { rx: -20, rz: -12 }, legR: { rx: -30, rz: 12 }, kneeL: [-74, 0, 0], kneeR: [-88, 0, 0], footL: [-30, 0, 0], footR: [-30, 0, 0] } },
