...
const G = {
  carry: { rx: -24, rz: 54 },        // resting on the shoulder between pitches
  cocked: { rx: -32, rz: 42 },       // up and behind the rear shoulder
  loaded: { rx: -46, rz: 58 },       // deeper, wrapped further behind the head
  launch: { rx: -10, rz: -4 },       // barrel dropping into the zone, hands still inside
  contact: { rx: 6, rz: -84, px: 0.3, pz: 0.24 },   // through the ball, arms extended
  wrap: { rx: 30, rz: -154 },        // wrapped clean over the front shoulder
  point: { rx: -8, rz: -64 },        // levelled out at the fire escape
};
...
C('stance', {
  ...
  keys: [
    { t: 0.0, pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46, rx: -6 }, legL: { rz: -14, rx: 6 }, legR: { rz: 15, rx: -8 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
    { t: 0.85, ease: 'hold', pose: { hips: { ry: -22, rz: 3 }, chest: { ry: -26, rx: 14 }, neck: { ry: 50, rx: -4 }, legL: { rz: -15, rx: 8 }, legR: { rz: 16, rx: -9 }, kneeL: [30, 0, 0], kneeR: [24, 0, 0], armL: { rx: 32, rz: -30 }, elbL: [-94, 0, 0], armR: { rx: 12, rz: -50 }, elbR: [-82, 0, 0], grip: { rx: G.cocked.rx - 10, rz: G.cocked.rz + 8 }, base: { py: -0.17 } } },
    { t: 1.7, ease: 'hold', pose: { hips: { ry: -16, rz: -2 }, chest: { ry: -20, rx: 11 }, neck: { ry: 44, rx: -8 }, legL: { rz: -13, rx: 5 }, legR: { rz: 14, rx: -7 }, kneeL: [23, 0, 0], kneeR: [20, 0, 0], armL: { rx: 22, rz: -24 }, elbL: [-84, 0, 0], armR: { rx: 5, rz: -43 }, elbR: [-72, 0, 0], grip: { rx: G.cocked.rx + 8, rz: G.cocked.rz - 6 }, base: { py: -0.12 } } },
    { t: 2.5, pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46, rx: -6 }, legL: { rz: -14, rx: 6 }, legR: { rz: 15, rx: -8 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
  ],
});
...
C('swing', {
  dur: 1.0,
  keys: [
    { t: 0.0, pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46 }, legL: { rz: -14, rx: 6 }, legR: { rz: 15, rx: -8 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
    // 1. LOAD — everything goes backwards first
    { t: 0.14, ease: 'out', pose: { hips: { ry: -34, rz: 5 }, chest: { ry: -44, rx: 15 }, neck: { ry: 60, rx: -4 }, legL: { rz: -15, rx: 14 }, legR: { rz: 16, rx: -22 }, kneeL: [34, 0, 0], kneeR: [30, 0, 0], armL: { rx: 34, rz: -34 }, elbL: [-98, 0, 0], armR: { rx: 16, rz: -56 }, elbR: [-88, 0, 0], grip: G.loaded, base: { py: -0.22 }, shirt: [-14, 0, 0] } },
    // 2. STRIDE — front foot goes out, hands stay behind
    { t: 0.27, ease: 'hold', pose: { hips: { ry: -30, rz: 4 }, chest: { ry: -46, rx: 17 }, neck: { ry: 62 }, legL: { rz: -15, rx: 16 }, legR: { rz: 20, rx: -40 }, kneeL: [30, 0, 0], kneeR: [16, 0, 0], footR: [16, 0, 0], armL: { rx: 36, rz: -36 }, elbL: [-100, 0, 0], armR: { rx: 18, rz: -58 }, elbR: [-90, 0, 0], grip: G.loaded, base: { py: -0.24, pz: 0.1 } } },
    // 3. LAUNCH — hips fire, chest lags, barrel drops into the zone
    { t: 0.36, ease: 'drive', pose: { hips: { ry: 16, rz: 2 }, chest: { ry: -14, rx: 15 }, neck: { ry: 40 }, legL: { rz: -12, rx: 8 }, legR: { rz: 16, rx: -26 }, kneeL: [24, 0, 0], kneeR: [10, 0, 0], armL: { rx: 18, rz: -22 }, elbL: [-84, 0, 0], armR: { rx: -6, rz: -38 }, elbR: [-70, 0, 0], grip: G.launch, base: { py: -0.2, pz: 0.06 } } },
    // 4. CONTACT — the freezable frame
    { t: 0.44, ease: 'whip', pose: { hips: { ry: 54, rz: -4 }, chest: { ry: 46, rx: 6 }, neck: { ry: 6, rx: -6 }, legL: { rz: -10, rx: -6 }, legR: { rz: 12, rx: -14 }, kneeL: [16, 0, 0], kneeR: [4, 0, 0], footL: [0, 0, 0], armL: { rx: -34, rz: -8 }, elbL: [-22, 0, 0], armR: { rx: -40, rz: -12 }, elbR: [-18, 0, 0], grip: G.contact, base: { py: -0.24, sy: -0.06, sx: 0.03, sz: 0.03 } } },
    // 5. hold the contact pose — the hitstop reads here
    { t: 0.5, ease: 'hold', pose: { hips: { ry: 60, rz: -5 }, chest: { ry: 52, rx: 5 }, neck: { ry: 2, rx: -8 }, legL: { rz: -10, rx: -8 }, legR: { rz: 12, rx: -14 }, kneeL: [14, 0, 0], kneeR: [3, 0, 0], armL: { rx: -38, rz: -6 }, elbL: [-18, 0, 0], armR: { rx: -44, rz: -10 }, elbR: [-14, 0, 0], grip: { rx: G.contact.rx + 8, rz: G.contact.rz - 4 }, base: { py: -0.22, sy: -0.04, sx: 0.02, sz: 0.02 } } },
    // 6. FOLLOW-THROUGH — bat wraps, back heel comes up, head tracks the ball
    { t: 0.66, ease: 'out', pose: { hips: { ry: 96, rz: -8 }, chest: { ry: 104, rx: -4 }, neck: { ry: -30, rx: -18 }, legL: { rz: -8, rx: -18, ry: 20 }, legR: { rz: 10, rx: -6 }, kneeL: [56, 0, 0], kneeR: [8, 0, 0], footL: [-40, 0, 0], armL: { rx: -102, rz: 22 }, elbL: [-104, 0, 0], armR: { rx: -96, rz: 8 }, elbR: [-96, 0, 0], grip: G.wrap, base: { py: -0.1, sy: 0.03 }, shirt: [22, 0, 0] } },
    { t: 0.82, ease: 'hold', pose: { hips: { ry: 104, rz: -6 }, chest: { ry: 112, rx: -2 }, neck: { ry: -40, rx: -20 }, legL: { rz: -8, rx: -20, ry: 24 }, legR: { rz: 10, rx: -4 }, kneeL: [62, 0, 0], kneeR: [6, 0, 0], footL: [-46, 0, 0], armL: { rx: -108, rz: 26 }, elbL: [-112, 0, 0], armR: { rx: -100, rz: 10 }, elbR: [-104, 0, 0], grip: { rx: G.wrap.rx + 10, rz: G.wrap.rz - 6 }, base: { py: -0.12 } } },
...
C('swing_check', {
  dur: 0.86,
  keys: [
    { t: 0.0, pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
    ...
    { t: 0.86, ease: 'settle', pose: { hips: { ry: -14 }, chest: { ry: -20, rx: 13 }, neck: { ry: 44 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
  ],
});
...
C('whiff', {
  ...
  keys: [
    { t: 0.0, pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
    { t: 0.15, ease: 'out', pose: { hips: { ry: -34, rz: 5 }, chest: { ry: -46, rx: 16 }, neck: { ry: 62 }, legR: { rx: -26 }, kneeL: [36, 0, 0], armL: { rx: 36, rz: -36 }, elbL: [-100, 0, 0], grip: G.loaded, base: { py: -0.24 } } },
...
C('point', {
  ...
  keys: [
    ...
    { t: 1.85, ease: 'settle', pose: { hips: { ry: -18 }, chest: { ry: -22, rx: 12 }, neck: { ry: 46 }, kneeL: [26, 0, 0], kneeR: [22, 0, 0], armL: { rx: 26, rz: -26 }, elbL: [-88, 0, 0], armR: { rx: 8, rz: -46 }, elbR: [-76, 0, 0], grip: G.cocked, base: { py: -0.14 } } },
  ],
});
...
C('cheer_arms', {
  dur: 1.05, loop: true, ease: 'inout',
  keys: [
    { t: 0.0, pose: { base: { py: -0.06, sy: -0.04, sx: 0.02, sz: 0.02 }, chest: { rx: -6 }, neck: { rx: -16 }, armL: { rx: -168, rz: 26 }, armR: { rx: -168, rz: -26 }, elbL: [-16, 0, 0], elbR: [-16, 0, 0], kneeL: [24, 0, 0], kneeR: [24, 0, 0] } },
    { t: 0.26, ease: 'whip', pose: { base: { py: 0.42, sy: 0.08, sx: -0.04, sz: -0.04 }, chest: { rx: -16, rz: 5 }, neck: { rx: -30 }, armL: { rx: -186, rz: 14 }, armR: { rx: -186, rz: -14 }, elbL: [-4, 0, 0], elbR: [-4, 0, 0], kneeL: [8, 0, 0], kneeR: [8, 0, 0], legL: { rx: 12 }, legR: { rx: -12 } } },
    { t: 0.53, ease: 'out', pose: { base: { py: -0.08, sy: -0.06, sx: 0.03, sz: 0.03 }, chest: { rx: -4, rz: -4 }, neck: { rx: -14 }, armL: { rx: -164, rz: 30 }, armR: { rx: -164, rz: -30 }, elbL: [-20, 0, 0], elbR: [-20, 0, 0], kneeL: [28, 0, 0], kneeR: [28, 0, 0] } },
    { t: 0.79, ease: 'whip', pose: { base: { py: 0.4, sy: 0.08, sx: -0.04, sz: -0.04 }, chest: { rx: -16, rz: -5 }, neck: { rx: -30 }, armL: { rx: -186, rz: 18 }, armR: { rx: -186, rz: -18 }, elbL: [-4, 0, 0], elbR: [-4, 0, 0], kneeL: [8, 0, 0], kneeR: [8, 0, 0], legL: { rx: -12 }, legR: { rx: 12 } } },
    { t: 1.05, pose: { base: { py: -0.06, sy: -0.04, sx: 0.02, sz: 0.02 }, chest: { rx: -6 }, neck: { rx: -16 }, armL: { rx: -168, rz: 26 }, armR: { rx: -168, rz: -26 }, elbL: [-16, 0, 0], elbR: [-16, 0, 0], kneeL: [24, 0, 0], kneeR: [24, 0, 0] } },
  ],
});
...
C('cheer_jump', {
  dur: 0.88, loop: true,
  keys: [
    { t: 0.0, ease: 'out', pose: { base: { py: -0.52, sy: -0.12, sx: 0.07, sz: 0.07 }, chest: { rx: 22 }, neck: { rx: -18 }, legL: { rx: -12, rz: -14 }, legR: { rx: -12, rz: 14 }, kneeL: [72, 0, 0], kneeR: [72, 0, 0], armL: { rx: 44, rz: 16 }, armR: { rx: 44, rz: -16 }, elbL: [-40, 0, 0], elbR: [-40, 0, 0] } },
    { t: 0.16, ease: 'whip', pose: { base: { py: 1.24, sy: 0.13, sx: -0.06, sz: -0.06 }, chest: { rx: -14 }, neck: { rx: -34 }, legL: { rx: 20, rz: -8 }, legR: { rx: 20, rz: 8 }, kneeL: [64, 0, 0], kneeR: [64, 0, 0], armL: { rx: -176, rz: 22 }, armR: { rx: -176, rz: -22 }, elbL: [-26, 0, 0], elbR: [-26, 0, 0], shirt: [-32, 0, 0] } },
    { t: 0.34, ease: 'hold', pose: { base: { py: 1.42, sy: 0.06, sx: -0.03, sz: -0.03 }, chest: { rx: -18, rz: 6 }, neck: { rx: -38 }, legL: { rx: 26, rz: -10 }, legR: { rx: 14, rz: 10 }, kneeL: [78, 0, 0], kneeR: [54, 0, 0], armL: { rx: -184, rz: 16 }, armR: { rx: -184, rz: -16 }, elbL: [-14, 0, 0], elbR: [-14, 0, 0] } },
    { t: 0.56, ease: 'whip', pose: { base: { py: -0.66, sy: -0.16, sx: 0.09, sz: 0.09 }, chest: { rx: 30 }, neck: { rx: -14 }, legL: { rx: -16, rz: -16 }, legR: { rx: -16, rz: 16 }, kneeL: [86, 0, 0], kneeR: [86, 0, 0], armL: { rx: -60, rz: 34 }, armR: { rx: -60, rz: -34 }, elbL: [-60, 0, 0], elbR: [-60, 0, 0], brim: [18, 0, 0] } },
    { t: 0.88, ease: 'out', pose: { base: { py: -0.52, sy: -0.12, sx: 0.07, sz: 0.07 }, chest: { rx: 22 }, neck: { rx: -18 }, legL: { rx: -12, rz: -14 }, legR: { rx: -12, rz: 14 }, kneeL: [72, 0, 0], kneeR: [72, 0, 0], armL: { rx: 44, rz: 16 }, armR: { rx: 44, rz: -16 }, elbL: [-40, 0, 0], elbR: [-40, 0, 0] } },
  ],
  events: [{ t: 0.56, name: 'land' }],
});
...
/** Being mobbed: arms up, getting shoved around by four smaller people. */
C('mobbed', {
  dur: 1.35, loop: true,
  keys: [
    { t: 0.0, ease: 'out', pose: { base: { py: 0.04, rz: 5 }, chest: { rx: -10, rz: -6 }, neck: { rx: -24, ry: 12 }, armL: { rx: -176, rz: 22 }, armR: { rx: -176, rz: -22 }, elbL: [-14, 0, 0], elbR: [-14, 0, 0], kneeL: [16, 0, 0], kneeR: [16, 0, 0] } },
    { t: 0.3, ease: 'snap', pose: { base: { py: 0.1, rz: -7, px: 0.12 }, chest: { rx: -14, rz: 8 }, neck: { rx: -28, ry: -14 }, armL: { rx: -184, rz: 14 }, armR: { rx: -184, rz: -14 }, elbL: [-8, 0, 0], elbR: [-8, 0, 0], kneeL: [8, 0, 0], kneeR: [22, 0, 0] } },
    { t: 0.62, ease: 'snap', pose: { base: { py: 0.16, rz: 8, px: -0.14 }, chest: { rx: -8, rz: -10 }, neck: { rx: -22, ry: 16 }, armL: { rx: -170, rz: 28 }, armR: { rx: -170, rz: -28 }, elbL: [-20, 0, 0], elbR: [-20, 0, 0], kneeL: [22, 0, 0], kneeR: [8, 0, 0] } },
    { t: 0.95, ease: 'snap', pose: { base: { py: 0.06, rz: -5, px: 0.08 }, chest: { rx: -16, rz: 5 }, neck: { rx: -30, ry: -8 }, armL: { rx: -182, rz: 18 }, armR: { rx: -182, rz: -18 }, elbL: [-10, 0, 0], elbR: [-10, 0, 0], kneeL: [12, 0, 0], kneeR: [18, 0, 0] } },
    { t: 1.35, ease: 'out', pose: { base: { py: 0.04, rz: 5 }, chest: { rx: -10, rz: -6 }, neck: { rx: -24, ry: 12 }, armL: { rx: -176, rz: 22 }, armR: { rx: -176, rz: -22 }, elbL: [-14, 0, 0], elbR: [-14, 0, 0], kneeL: [16, 0, 0], kneeR: [16, 0, 0] } },
  ],
});
